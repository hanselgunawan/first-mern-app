...
in all web browsers. Service worker registration [won't be attempted](public/src/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](public/src/registerServiceWorker.js), which
